function ReportTable(props) {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-1 text-gray-400 justify-items-center">
      <table >
        <thead >
          <th className="px-2 text-sm text-green-400">Location</th>
          <th className="px-2 text-sm text-green-400">6AM</th>
          <th className="px-2 text-sm text-green-400">7AM</th>
          <th className="px-2 text-sm text-green-400">8AM</th>
          <th className="px-2 text-sm text-green-400">9AM</th>
          <th className="px-2 text-sm text-green-400">10AM</th>
          <th className="px-2 text-sm text-green-400">11AM</th>
          <th className="px-2 text-sm text-green-400">12PM</th>
          <th className="px-2 text-sm text-green-400">1PM</th>
          <th className="px-2 text-sm text-green-400">2PM</th>
          <th className="px-2 text-sm text-green-400">3PM</th>
          <th className="px-2 text-sm text-green-400">4PM</th>
          <th className="px-2 text-sm text-green-400">5PM</th>
          <th className="px-2 text-sm text-green-400">6PM</th>
          <th className="px-2 text-sm text-green-400">7PM</th>
          <th className="px-2 text-sm text-green-400">Total</th>
        </thead>
        <tbody>
            ...
            return (
              <tr>
                <td className="grid grid-cols-3 grid-rows-1 justify-items-center">
                  ...
                  <div className="col-span-2 px-2 text-green-400">
